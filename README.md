...
- **HUB Principal** — 4 categorias grandes (`HUB_CATEGORIES`, ordem fixa): **Campanha** e **Free Play** levam ao Carrossel filtrado por `StageDef.selectable_mode`; **Arquivos (Vault)** e **Calibração** são telas-fim próprias.
